### Define Tailwind CSS Color Palette with CSS Variables

Source: https://tailwindcss.com/docs/colors

This code snippet defines a comprehensive set of color variables using CSS custom properties. Each color is specified using the Oklch color function, providing a flexible and consistent color scale for various shades of zinc, neutral, and stone, as well as black and white. These variables can be referenced throughout a CSS or Tailwind CSS project to maintain a consistent color theme and enable easy customization.
...
### Define a Full Custom Tailwind Color Palette

Source: https://tailwindcss.com/docs/colors

Explains how to completely disable all default Tailwind colors by setting `--color-*: initial` and then defining a custom, independent color palette with specific color variables within the `@theme` directive.
...
### Override Default Tailwind Colors via @theme

Source: https://tailwindcss.com/docs/colors

Shows how to redefine existing Tailwind default color variables (e.g., `--color-gray-50`) by declaring them with new values within the `@theme` directive, using modern color formats like `oklch`.
...
### Tailwind CSS Outline Color Utility Definitions (CSS)

Source: https://tailwindcss.com/docs/outline-color

This snippet provides a comprehensive list of Tailwind CSS utility classes for setting outline colors, along with their corresponding CSS properties and `oklch()` color function values. It includes variations for gray, zinc, neutral, and stone color palettes, as well as custom property and arbitrary value support.
...
### Adjust Color Opacity with Tailwind's --alpha() Function

Source: https://tailwindcss.com/docs/colors

Illustrates the use of Tailwind's `--alpha()` function to dynamically control the opacity of CSS color variables within custom CSS rules, making it easier to create variations of existing colors.
...
### Define Oklch Color Palette as CSS Custom Properties

Source: https://tailwindcss.com/docs/colors

This snippet provides a collection of CSS custom properties, each defining a specific color and shade using the Oklch color model. These variables are intended to be used throughout a web project, particularly with frameworks like Tailwind CSS, to ensure consistent styling and easy management of color themes. The Oklch format offers improved perceptual uniformity compared to traditional RGB or HSL.

```css
--color-sky-50: oklch(0.97 0.015 230.932);
--color-sky-100: oklch(0.93 0.033 231.298);
--color-sky-200: oklch(0.878 0.06 232.661);
--color-sky-300: oklch(0.796 0.101 232.661);
...
### Use Tailwind Colors as Arbitrary Utility Values in HTML

Source: https://tailwindcss.com/docs/colors

Shows how to apply Tailwind CSS color variables as arbitrary values within utility classes, leveraging functions like `light-dark()` for dynamic theming based on user preferences.
...
### Display Tailwind CSS Color Palette Steps with HTML

Source: https://tailwindcss.com/docs/colors

This HTML snippet demonstrates how to display the 11 steps of a single color (sky) from the default Tailwind CSS color palette. Each `div` element uses a `bg-sky-X00` class to showcase the different shades from 50 (lightest) to 950 (darkest), illustrating the full gradient range available for each color.
...
### Reference Tailwind Colors in CSS

Source: https://tailwindcss.com/docs/colors

Demonstrates how to use Tailwind CSS color variables (e.g., `--color-gray-950`, `--color-blue-500`) directly within custom CSS rules, including nested rules for pseudo-classes like `:hover`.
